import pygame
from game_object import human_poster, zombie_poster, loading_background
...
def character_customization(screen):
    ...
    # Initial setup
    stats = {"HP": 0, "Stamina": 0, "Speed": 0, "Awareness radius": 0}
    points = 10
    customizing = True
    ...
    while customizing:
        ...
        start_text = font.render("Next", True, (255, 255, 255))
...
# Creating zombie character
# ----------------------------------------------------------------------------------------------

def zombie_customization(screen):
    font = pygame.font.Font(None, 40)
    input_font = pygame.font.Font(None, 36)

    # Initial setup
    stats = {"HP": 0, "Stamina": 0, "Speed": 0, "Awareness radius": 0, "Infection probability": 0}
    points = 10
    customizing = True
    ...
    while customizing:
        ...
        title = font.render("Customize your zombie", True, (255, 255, 255))
        screen.blit(title, (140, 50))
